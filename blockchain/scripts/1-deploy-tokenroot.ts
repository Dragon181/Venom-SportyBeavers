...
async function main() {
  ...
  const initialSupplyTo   = new Address("0:9080ef4369fd6becd3a0f6133bd54bb29f5f3921108343a0acb11c414c3e94f8")
  // Address of token owner (write your own)
  const rootOwner         = new Address("0:9080ef4369fd6becd3a0f6133bd54bb29f5f3921108343a0acb11c414c3e94f8")
  // Name of the token
  const name              = "SportyBeavers"
  // Symbol of the token
  const symbol            = "BEAV"
